// Adapted from D:/4lpha-execution/web/components/explainers/TradeExplainer.tsx; original geometry retained, docs copy and playback corrected.
import React from "react";

const SCENES = [{
  t: 0,
  title: "It screens the permitted shortlist",
  body: "Only candidates inside the pinned session universe can be assessed. New tokens outside the grant cannot be added by the model."
}, {
  t: 1700,
  ...
  body: "Owner settings and usable quotes govern exits. Model-assisted exits can apply when thresholds are unspecified."
}, {
  t: 6400,
  title: "An exit threshold is evaluated",
  body: "This example crosses an exit target. A threshold is not a guaranteed fill price, and break-even does not remove execution risk."
}, {
  t: 8200,
...
function TradeExplainer({
  ...
  const FILLS = [{
    ...
    t: TP_AT,
    tone: "ok",
    text: "Example target crossed at +40%",
    sub: "illustrative exit evaluation"
  }, {
    t: EXIT_AT,
    tone: "ok",
    text: "Closed +31.4% net",
    sub: "illustrative outcome, not a receipt"
  }];
