// Adapted from D:/4lpha-execution/web/components/explainers/CompoundExplainer.tsx; original geometry retained, docs copy and playback corrected.
...
const SCENES = [{
  ...
  body: "The worker checks your signed harvest threshold and execution conditions before compounding."
}, {
  t: 4900,
  title: "Floor cleared",
  body: "The example clears its threshold. This does not by itself prove that compounding is profitable."
}, {
  t: 6400,
  ...
  body: "The range is unchanged and liquidity has increased. Future fees still depend on price, market activity and costs."
}];
const TOTAL = 10000;
const CLEAR_AT = 4900,
  RUN_AT = 6400,
